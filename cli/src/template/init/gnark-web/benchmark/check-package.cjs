...
assert.deepEqual(files.filter(path => path.startsWith("gnark/")).sort(), [
    "gnark/LICENSE-APACHE", "gnark/gnark.d.ts", "gnark/gnark.js",
    "gnark/gnark.wasm", "gnark/gnark.worker.js", "gnark/wasm_exec.js",
].sort(), "Unexpected gnark package contents");
...
console.log("Gnark npm package contains the Go runtime and required assets.");
if (temporary) {
    try {
